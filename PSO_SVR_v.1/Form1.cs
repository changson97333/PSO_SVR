...
namespace PSO_SVR_v._1
{
    public partial class Form1 : Form
    {
        ...
        double[] max, min, vMax, error, fx, alpha, alpha_star, batasAtas, batasBawah;
        ...
        void load_data()
        {
            ...
            //========menghitung kolom
            string kolomz = null;
            string sql1 = "SELECT COUNT( * ) FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema ='data_see'AND table_name =  'see_';";
            ...
            string sql2 = "SELECT count(*) FROM see_;";
